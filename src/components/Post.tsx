...
//     // For comments within the last 3 days
//     if (diffDays < 3) {
//       if (diffHours < 1) {
...
//       }
//     }
//     // For older comments (more than 3 days old)
//     else {
//       // Format as "Last comment DD MMM" (e.g., "Last comment 19 Feb")
...
//   // Toggle menu (with stopPropagation to prevent triggering post click)
...
//   // Format the last comment time (if available)
//   const lastCommentTimeFormatted = formatLastCommentTime(post.lastComment);

//   // Define card style based on pinned status
...
export default function Post({ post, onRefresh, onDelete }: PostProps) {
  ...
  // Check if post has any media (image or youtube)
...
// // components/Post.tsx - Main optimized component
...
// import { usePostInteractions } from "./subcomPostcard/usePostInteractions";
// import { PostHeader } from "./subcomPostcard//PostHeader";
// import { PostContent } from "./subcomPostcard//PostContent";
// import { PostMedia } from "./subcomPostcard//PostMedia";
// import { PostFooter } from "./subcomPostcard//PostFooter";
// import { DeleteModal } from "./subcomPostcard//DeleteModal";

// // Lazy load heavy components
// const LazyYouTubeModal = lazy(() => import("./subcomPostcard//YouTubeModal"));
...
// const Post = memo(({ post, onRefresh, onDelete }: PostProps) => {
//   const { user } = useAuth();
//   const { likedPosts, likeCounts } = usePostState();
//   const { handleLike, handleDelete, isLiking, isDeleting } = usePostInteractions(
//     post,
//     onRefresh,
//     onDelete
//   );
...
//   // Card style based on pinned status
//   const cardStyle = post.isPinned
//     ? {
//         border: "1px solid rgb(248, 212, 129)",
//         boxShadow:
...
//   const handleOpenYoutube = useCallback((e: React.MouseEvent) => {
//     e.preventDefault();
//     e.stopPropagation();
//     setShowYoutubeModal(true);
//   }, []);

//   const handleCloseYoutube = useCallback((e: React.MouseEvent) => {
//     e.preventDefault();
//     e.stopPropagation();
//     setShowYoutubeModal(false);
//   }, []);
...
//           lastCommentTime={post.lastComment}
//           onLike={handleLike}
//           isLiking={isLiking}
//           user={user}
//         />
...
//       {/* Modals - Lazy loaded */}
//       {showYoutubeModal && post.youtubeLink && (
