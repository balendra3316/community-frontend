...
//               <button
//                 type="submit"
//                 disabled={(!commentText.trim() && !imageFile) || hasError}
//                 className={`ml-2 ${
//                   (commentText.trim() || imageFile) && !hasError
//                     ? 'text-blue-600 hover:text-blue-700' 
//                     : 'text-gray-400 cursor-not-allowed'
//                 }`}
//               >
        ...
        <div className="flex-1 relative">
          <div className="flex flex-col w-full">
            <div className="flex items-center border rounded-full px-4 py-2 bg-gray-50">
              ...
              <button
                type="submit"
                disabled={(!commentText.trim() && !imageFile) || hasError || isSubmitting}
                className={`ml-2 ${
                  (commentText.trim() || imageFile) && !hasError && !isSubmitting
                    ? 'text-blue-600 hover:text-blue-700' 
                    : 'text-gray-400 cursor-not-allowed'
                }`}
              >
