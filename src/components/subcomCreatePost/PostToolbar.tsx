...
// components/subcomCreatePost/PostToolbar.tsx
...
import {
  ...
  YouTube as YoutubeIcon,
  Link as LinkIcon,
  Videocam as VideocamIcon, // Import VideocamIcon
} from "@mui/icons-material";
...
interface PostToolbarProps {
  ...
  onCategorySelect: (category: string) => void;
  onImageUpload: (file: File, preview: string) => void;
  onVideoUpload: (file: File) => void; // New prop for video upload
  onYoutubeClick: () => void;
  onLinkClick: () => void;
  onPollClick: () => void;
}
...
const PostToolbar = memo(
  ({
    ...
    onCategorySelect,
    onImageUpload,
    onVideoUpload, // Destructure new prop
    onYoutubeClick,
    onLinkClick,
    onPollClick,
  }: PostToolbarProps) => {
