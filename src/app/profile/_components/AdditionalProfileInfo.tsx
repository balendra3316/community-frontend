...
const profileSchema = z.object({
  ...
  goals: z
    .string()
    .max(1000, "Goals text is too long")
    .optional()
    .or(z.literal("")),
  dob: z
    .date()
...
export default function AdditionalProfileInfo({
  user,
  onUpdateStart,
  onUpdateEnd,
  ...
  const {
    ...
    defaultValues: {
      ...
      acdStarClubRegisterDate: user.acdStarClubRegisterDate
        ? new Date(user.acdStarClubRegisterDate)
        : null,
    },
  });
    ...
    <div className="mt-6">
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <TextField
            ...
            sx={{
              "& .Mui-focused .MuiOutlinedInput-notchedOutline": {
                borderColor: themeYellow.primary,
              },
          ...
          <TextField
            label="Membership ID"
            value={user.membershipId || "Will be generated on first update"}
            InputProps={{ readOnly: true }}
            fullWidth
            sx={{
              "& .Mui-focused .MuiOutlinedInput-notchedOutline": {
              ...
              render={({ field }) => (
                <DatePicker
                  ...
                  slotProps={{
                    textField: {
                      fullWidth: true,
                      error: !!errors.acdStarClubRegisterDate,
                      helperText: errors.acdStarClubRegisterDate?.message,
                    },
                  }}
                />
              )}
        ...
        <div className="mt-4">
          <Button
            ...
            sx={{
              ...
              "&:hover": { bgcolor: themeYellow.primaryDark },
            }}
          >
