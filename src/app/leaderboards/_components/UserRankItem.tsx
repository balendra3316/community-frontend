...
// const UserRankItem: React.FC<UserRankItemProps> = ({ user, isCurrentUser = false }) => {
//   const { rank, name, avatar, points } = user;
  
//   // Determine if this is a top-3 position for medal
//   const isTopRank = rank && rank <= 3;
//   const rankColor = isTopRank ? RANK_COLORS[rank as keyof typeof RANK_COLORS] : undefined;
...
const UserRankItem: React.FC<UserRankItemProps> = memo(({ user, isCurrentUser = false }) => {
  const { rank, name, avatar, points } = user;
