...
// // Define the shape of the summary prop
...
//     <Paper elevation={2} className="p-4 rounded-lg flex items-center space-x-4 bg-white">
//         <div className="p-3 bg-blue-100 rounded-full">
//             {icon}
//         </div>
//         <div>
//             <Typography variant="body2" className="text-gray-500 font-medium">{title}</Typography>
...
//                 <StatCard icon={<AccessTime color="primary" />} title="Total Practice" value={summary.totalMinutes} unit="min" />
//                 <StatCard icon={<Whatshot sx={{ color: '#ef5350' }} />} title="Current Streak" value={summary.currentStreak} unit="days" />
//                 <StatCard icon={<EmojiEvents sx={{ color: '#ffc107' }} />} title="Longest Streak" value={summary.longestStreak} unit="days" />
//                 <StatCard icon={<FitnessCenter sx={{ color: '#4caf50' }} />} title="Badges Earned" value={summary.badges.length} unit="badges" />
//             </div>
//         </div>
//     );
// }
