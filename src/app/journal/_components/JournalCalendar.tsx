...
// import { fetchJournalDatesForMonth } from '../../../lib/journalSlice'; // Adjust path
...
//     const firstDayOfMonth = startOfMonth.day(); // 0 = Sunday, 1 = Monday...
...
//                 <Typography variant="h6" className="font-semibold text-center">{currentDate.format('MMMM YYYY')}</Typography>
...
//                                 ${hasEntry ? 'bg-blue-500 text-white' : ''}
//                             `}>
//                                 {day.date()}
//                             </div>
//                         </div>
